...
const BNParameter_Engine BNParameter_Engine_Engine_MAX = BNParameter_Engine_CAFFE;
...
class LayerParameter : public ::google::protobuf::Message {
 public:
  ...
  // optional .caffe.BNParameter bn_param = 222;
  inline bool has_bn_param() const;
  inline void clear_bn_param();
  static const int kBnParamFieldNumber = 222;
  ...
  // optional .caffe.InterpParameter interp_param = 223;
  inline bool has_interp_param() const;
  inline void clear_interp_param();
  static const int kInterpParamFieldNumber = 223;
...
class BNParameter : public ::google::protobuf::Message {
 public:
  ...
  // optional .caffe.BNParameter.Engine engine = 6 [default = CAFFE];
